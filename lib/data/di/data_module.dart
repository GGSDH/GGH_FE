...
void setupLocator() {
  ...
  getIt.registerLazySingleton<TripDataSource>(() => TripDataSourceImpl(getIt<DioClient>().dio));
  getIt.registerLazySingleton<TripRepository>(() => TripRepositoryImpl(getIt<TripDataSource>()));
